...
6. deterministic fixtures, replay inputs, tests, evidence and static negative-capability scanning for this scope.
...
The implementation must trace to the frozen R05/R11 requirements and retain the applicable restrictions from the R12 baseline. At minimum:
...
- R05 authority, persistence isolation, schema quarantine and validation requirements;
