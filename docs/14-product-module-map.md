...
17. **HCT Intelligence Brain** — reasoning/orchestration layer that combines indicators, patterns, regime, historical memory, market-state integrity and risk context before approving a candidate signal for downstream risk evaluation.
...
23. **Safety & Protection Governor** — independent fail-safe layer capable of denying new exposure regardless of strategy/AI output.
...
31. **Backtest / Replay / Paper Trading / Simulation** — deterministic research path before production promotion, including user-authored strategies, execution shadow simulation and market-data replay fidelity validation.
